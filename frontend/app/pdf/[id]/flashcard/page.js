...
function FlashcardPageContent() {
  ...
  const generateFlashcards = async () => {
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/pdfs/${params.id}/flashcards`, {
        method: 'POST',
        headers: {
      ...
      if (data.success) {
        setGeneratedMaterial(data.flashcards)
      } else {
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 flex items-center justify-center">
        <div className="text-center">
          <div className="relative">
            <div className="animate-spin rounded-full h-20 w-20 border-4 border-gray-200 border-t-purple-500"></div>
            <div className="absolute inset-0 animate-pulse rounded-full h-20 w-20 border-4 border-transparent border-t-purple-200"></div>
          </div>
          <h2 className="mt-6 text-2xl font-bold text-gray-900">
            Generating Flashcards...
          </h2>
          <p className="mt-2 text-gray-600">
            Extracting content from pages {startPage}-{endPage} and generating study cards
          </p>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 flex items-center justify-center">
        <div className="text-center max-w-md mx-auto p-8">
          ...
          <button
            ...
            className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-purple-500 to-purple-600 text-white font-medium rounded-lg hover:from-purple-600 hover:to-purple-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
          >
