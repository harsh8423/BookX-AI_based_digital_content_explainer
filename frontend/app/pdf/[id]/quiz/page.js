...
function QuizPageContent() {
  ...
  const generateQuiz = async () => {
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/pdfs/${params.id}/quizzes`, {
        method: 'POST',
        headers: {
      ...
      if (data.success) {
        setGeneratedMaterial(data.quiz)
      } else {
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 flex items-center justify-center">
        <div className="text-center">
          <div className="relative">
            ...
            <div className="absolute inset-0 animate-pulse rounded-full h-20 w-20 border-4 border-transparent border-t-orange-200"></div>
          </div>
          <h2 className="mt-6 text-2xl font-bold text-gray-900">
            Generating Quiz...
          </h2>
          <p className="mt-2 text-gray-600">
            Extracting content from pages {startPage}-{endPage} and generating quiz questions
          </p>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 flex items-center justify-center">
        <div className="text-center max-w-md mx-auto p-8">
          ...
          <button
            ...
            className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-orange-500 to-orange-600 text-white font-medium rounded-lg hover:from-orange-600 hover:to-orange-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
          >
